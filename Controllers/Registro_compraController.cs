...
namespace ProyectoPeluqueria.Controllers
{
    public class Registro_compraController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "Id_compra,Fecha_compra,costo_unidad,total_unidades,Id_proveedor,Id_insumo")] Registro_compra registro_compra)
        {
            ...
            ViewBag.Id_insumo = new SelectList(db.Insumo, "Id_insumo", "Nombre_insumo", registro_compra.Id_insumo);
            ViewBag.Id_proveedor = new SelectList(db.Proveedor, "Id_proveedor", "Nombre_proveedor", registro_compra.Id_proveedor);
            return View(registro_compra);
        }
