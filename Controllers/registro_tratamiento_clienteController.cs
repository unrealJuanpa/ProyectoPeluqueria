...
namespace ProyectoPeluqueria.Controllers
{
    public class registro_tratamiento_clienteController : Controller
    {
        ...
        {
            ViewBag.Id_Cliente = new SelectList(db.Cliente, "Id_Cliente", "Primer_nombre_Cliente");
            ViewBag.CUI_empleado = new SelectList(db.Empleado, "CUI_empleado", "Primer_nombre_empleado");
        ...
        public ActionResult Create([Bind(Include = "Id_registro,Fecha,Costo,Id_Cliente,CUI_empleado,Id_tipo_tratamiento")] registro_tratamiento_cliente registro_tratamiento_cliente)
        {
            ...
            ViewBag.Id_Cliente = new SelectList(db.Cliente, "Id_Cliente", "Primer_nombre_Cliente", registro_tratamiento_cliente.Id_Cliente);
            ViewBag.CUI_empleado = new SelectList(db.Empleado, "CUI_empleado", "Primer_nombre_empleado", registro_tratamiento_cliente.CUI_empleado);
