...
namespace ProyectoPeluqueria.Controllers
{
    public class Retirar_productoController : Controller
    {
        ...
        public ActionResult Create()
        {
            ...
            ViewBag.Id_insumo = new SelectList(db.Insumo, "Id_insumo", "Nombre_insumo");
        ...
        public ActionResult Create([Bind(Include = "Id_retirar_producto,Fecha_retiro,Unidades_Retira,Id_insumo,CUI_empleado,Id_retiro_producto")] Retirar_producto retirar_producto)
        {
            ...
            ViewBag.CUI_empleado = new SelectList(db.Empleado, "CUI_empleado", "Primer_nombre_empleado", retirar_producto.CUI_empleado);
            ViewBag.Id_insumo = new SelectList(db.Insumo, "Id_insumo", "Nombre_insumo", retirar_producto.Id_insumo);
